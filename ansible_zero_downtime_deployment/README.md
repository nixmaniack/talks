...
The HAProxy web interface can be reached at http://<ip-of-lb>:9999

The default username and password are "haadmin" / "haadmin"
...
### Notes
Check PREREQUISITE.md file for demo related requirements.
